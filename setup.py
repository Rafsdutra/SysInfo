...
setup(
    name='SysInfo',
    version='',
    packages=['venv.lib.python3.6.site-packages.fpdf', 'venv.lib.python3.6.site-packages.psutil',
              'venv.lib.python3.6.site-packages.psutil.tests', 'venv.lib.python3.6.site-packages.cpuinfo',
    ...
    author='rafael',
    author_email='',
    description='Sistema para coletar informações sobre as máquinas da empresa'
)
